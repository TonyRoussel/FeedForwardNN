...
syn1 = 2 * Matrix.random(4, 4) - 1
syn2 = 2 * Matrix.random(4, 1) - 1
...
for j in xrange(60000):
    ...
    syn2 += 0.05 * (l2.transpose().dotProduct(l3_delta))
    syn1 += 0.05 * (l1.transpose().dotProduct(l2_delta))
    syn0 += 0.05 * (l0.transpose().dotProduct(l1_delta))
